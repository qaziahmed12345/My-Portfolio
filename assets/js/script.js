$(document).ready(function () {
    ...
    var typed = new Typed(".typing-text", {
        strings: ["Prompt Engineer", "front-end development", "web development"],
        loop: true,
        typeSpeed: 50,
        backSpeed: 25,
        backDelay: 500,
    ...
    // Create logo rain effect
    const effectContainer = document.createElement('div');
    effectContainer.className = 'shopify-effect';
    document.querySelector('.skills .container').appendChild(effectContainer);

    function createLogoRain() {
        const logo = document.createElement('div');
        logo.className = 'shopify-logo';
        logo.style.backgroundImage = 'url(https://placehold.co/30x30/7f73eb/white?text=SP)'; // Replace with actual logo URL
        logo.style.width = '30px';
        logo.style.height = '30px';
        logo.style.left = Math.random() * 100 + '%';
        logo.style.top = '-30px';
        logo.style.animationDuration = (Math.random() * 2 + 1) + 's';

        effectContainer.appendChild(logo);
